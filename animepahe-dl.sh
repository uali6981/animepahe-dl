...
get_episode_list() {
    ...
    # print_info "${_API_URL}?m=release&id=${1}&sort=episode_asc&page=${2}"
}
...
get_episode_link() {
    ...
    # print_info "${_API_URL}?m=embed&id=${i}&session=${s}&p=kwik"
...
download_episode() {
    ...
    v="C:/Users/Hafiz-Usman-Ali/Downloads/Video/${_ANIME_NAME}/${_ANIME_NAME} Ep ${num}.mp4"
    ...
    if [[ -z ${_LIST_LINK_ONLY:-} ]]; then
        ...
        if [[ ${_PARALLEL_JOBS:-} -gt 1 ]]; then
            ...
            opath="C:/Users/Hafiz-Usman-Ali/Downloads/Video/${_ANIME_NAME}/.${_ANIME_NAME} Ep ${num}"
